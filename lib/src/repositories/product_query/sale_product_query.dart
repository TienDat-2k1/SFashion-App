...
class SaleProductQuery {
  static Future<ListProductReponse> getLimitSaleProduct(int numberLimit) async {
    try {
      ...
      logger.e(e.toString());
      return ListProductReponse.error('Failured in get sale products');
    }
    return ListProductReponse.error('Failured in get sale products');
  }
}
